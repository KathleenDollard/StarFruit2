...
Namespace TwoLayerCli
   Public Class CliRootCommandSourceResult
      ...
      Public Overrides   Function CreateInstance() As CliRoot
         Dim newItem = New CliRoot(ctorParamOption_Result.Value)
         newItem.StringProperty = StringPropertyOption_Result.Value
         Return newItem
   End Function
End Class
Public Class FindCommandSourceResult
   Inherits CliRootCommandSourceResult
   Public Sub New(parseResult As ParseResult, commandSource As FindCommandSource, exitCode As Integer)
...
End Class
Public Class ListCommandSourceResult
   Inherits CliRootCommandSourceResult
   Public Sub New(parseResult As ParseResult, commandSource As ListCommandSource, exitCode As Integer)
      MyBase.New(parseResult, TryCast(commandSource.ParentCommandSource, CliRootCommandSource), exitCode)
