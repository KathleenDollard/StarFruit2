...
namespace StarFruit2.Generate
{
    ...
    public class VBPingGenerator : ISourceGenerator
    {
        ...
        {
            context.RegisterForSyntaxNotifications(() => new PingVBSyntaxReceiver());
        }

        public void Execute(GeneratorExecutionContext context)
        {
            if (context.SyntaxReceiver is not PingVBSyntaxReceiver receiver)
                return;
    ...
    public class PingVBSyntaxReceiver : ISyntaxReceiver
    {
